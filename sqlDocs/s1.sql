...
INSERT INTO medewerkers(mnr, naam, voorl, functie, chef, gbdatum, maandsal, comm,
                        afd, geslacht)
VALUES (8000, 'DONK', 'A', 'MANAGER', 7839, '2001-05-01', 12, NULL, 50, 'M');
...
CREATE SEQUENCE afdelingen_anr
    increment 10
    start 10
    minvalue 10
    maxvalue 2147483647
...
INSERT INTO afdelingen (anr, naam, locatie, hoofd)
VALUES (nextval('afdelingen_anr'), 'JAP', 'AMSTERDAM', null);
...
(
    med_mnr      int,
    postcode     VARCHAR
        CONSTRAINT char_ck CHECK (postcode LIKE '[0-9][0-9][0-9][0-9][A-Z][A-Z]'),
    huisnummer   INT,
    ingangsdatum DATE,
    einddatum    DATE
        CONSTRAINT dat_ck CHECK ( einddatum > ingangsdatum ),
    telefoon     INT UNIQUE
        CONSTRAINT correcte_nummer CHECK (telefoon = 10),
