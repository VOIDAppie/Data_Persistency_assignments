...
WHERE u.locatie IN ('UTRECHT', 'MAASTRICHT');
...
INSERT INTO medewerkers (mnr, naam, voorl, functie, chef, gbdatum, maandsal, comm,
                         afd)
VALUES(8001, 'ELCIK', 'A', 'STAGIAIR', 7369, '2001-05-01', 12, NULL, 20);
-- ON CONFLICT DO NOTHING;                                                                                         -- [TEST]
...
ON CONFLICT DO NOTHING;                                                                                         -- [TEST]
INSERT INTO uitvoeringen (cursus, begindatum, docent, locatie)
VALUES ('D&P', '2023-09-20', '7369', 'Leerdam'),
       ('D&P', '2023-10-15', '7369', 'Leerdam');
ON CONFLICT DO NOTHING;                                                                                         -- [TEST]
INSERT INTO inschrijvingen (cursist, cursus, begindatum)
VALUES (8001, 'D&P', '2023-09-20'),
       (7876, 'D&P', '2023-09-20'),
       (7499, 'D&P', '2023-10-15');
-- [TEST]
...
WHERE functie = 'MANAGER' AND afd = 7698;
...
DELETE FROM medewerkers
WHERE naam = 'ALDERS';
-- Dit lukt niet omdat de foreign key restraint hierdoor violated wordt,
-- de key (mnr 7499) wat behoort tot Alders is nog steeds in gebruik in table inschrijvingen,
-- dan zou hij daar eerst verwijderd moeten worden voordat hij hier verwijderd kan worden.
